...
//
//    @Autowired
//    public DataService(ProductDBMapper investingDBMapper, UserDBMapper userDBMapper) {
...
//        productMetaEntity.setProduct_id(productId);
//        productMetaEntity.setTitle(title);
//        productMetaEntity.setTotal_investing_amount(totalInvestingAmount);
//        productMetaEntity.setStarted_at(startedAt);
